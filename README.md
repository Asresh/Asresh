...
| --- | --- |
| 🔁 **[RTL-Projects-Everyday](https://github.com/Asresh/RTL-Projects-Everyday)** | A new **SystemVerilog RTL** design, simulated end-to-end with Icarus Verilog. |
| 🧪 **[Design-Verification-Projects-Everyday](https://github.com/Asresh/Design-Verification-Projects-Everyday)** | A new **verification** exercise — testbenches, checkers, and coverage. |
| 🧮 **[Computer-Architecture-Projects-Everyday](https://github.com/Asresh/Computer-Architecture-Projects-Everyday)** | A new **computer-architecture** build — datapaths, pipelines, and control. |
...
3. Build    →  Ship the full stack: frontend, backend, data, and AI where it earns its place.
4. Launch   →  Put a working version in front of users, measure, and iterate.
```

I lead each build the way I'd lead a team: **a clear problem, decisive scope, end-to-end ownership, and something shipped** — whether it's testing a startup idea, streamlining an internal workflow, or exploring an AI feature.
...
- 🔁 Ship a **new hardware design every day** across three daily-build portfolios
